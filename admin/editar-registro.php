      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>llena el formulario para modificar un usuario registrado</small>
          </h1>
        </section>
        <div class="row">
          <div class="col-md-8">
                ...
                <form class="form-horizontal editar-registrado" name="guardar-registro" id="guardar-registro" method="POST" action="modelo-registrado.php">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="email" class="form-control" id="email" name="email" placeholder="Correo Electrónico" value="<?php echo $registrado['email_registrado']; ?>">
                      </div>
                    </div>
                    <?php
                          ...
                          <li class="col-md-4">
                            <div class="tabla-precio text-center">
                              ...
                              <div class="orden">
                                ...
                                <input value="<?php echo $boletos['un_dia']['cantidad']; ?>" class="form-control" type="number" min="0" id="pase_dia" size="3" name="boletos[un_dia][cantidad]" placeholder="0">
                          ...
                          <div id="<?php echo str_replace('á', 'a', $dia); ?>" class="contenido-dia row">
                            ...
                            <div class="evento-flex">
                              ...
                              <div class="col-md-4">
                                ...
                                <label>
                                  <input <?php echo(in_array($evento['id'], $id_eventos_registrados['eventos']) ? 'checked' : ''); ?> type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>"><time><?php echo $evento['hora']; ?></time>
                        ...
                        <div class="caja row">
                          <div class="extras col-md-6">
                            <div class="orden">
                              ...
                              <input value="<?php echo $boletos['camisas']; ?>" class="form-control" type="number" min="0" id="camisa_evento" size="3" name="pedido_extra[camisas][cantidad]" placeholder="0">
                            ...
                            <div class="orden">
                              <label for="etiquetas">Paquetes de 10 etiquetas $2 <small>(HTML5, CSS3, JavaScript,
                                  Chrome)</small></label>
                              <input value="<?php echo $boletos['etiquetas']; ?>" class="form-control" type="number" min="0" id="etiquetas" size="3" name="pedido_extra[etiquetas][cantidad]" placeholder="0">
                          ...
                          <div class="total col-md-6">
                            ...
                            <p>Total Anterior: <?php echo $registrado['total_pagado']; ?></p>
                            <p>Total:</p>
                            <div id="suma-total">
