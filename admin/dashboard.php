      ...
      <div class="content-wrapper">
        ...
        <h2 class="page-header">
            ...
            <div class="row">    
                ...
                <div class="col-lg-3 col-xs-6">
                    <?php
                        $sql = "SELECT COUNT(total_pagado) AS pulseras FROM registrados WHERE pagado = 1 AND regalo = 2";
                        $resultado = $conn->query($sql);
                        $registrados = $resultado->fetch_assoc();
                    ?>
                    <!-- small box -->
                ...
                <div class="col-lg-3 col-xs-6">
                    <?php
                        $sql = "SELECT COUNT(total_pagado) AS pulseras FROM registrados WHERE pagado = 1 AND regalo = 3";
                        $resultado = $conn->query($sql);
                        $registrados = $resultado->fetch_assoc();
                    ?>
                    <!-- small box -->
